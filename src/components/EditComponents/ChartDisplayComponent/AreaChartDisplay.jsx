      ...
      <ResponsiveContainer width="100%" height="100%" debounce={50}>
        ...
        >
          ...
          <XAxis
            ...
            // interval={styleSetting.layout === 'horizontal' ? 'preserveStartEnd' : null }
            ...
            // padding='gap'
            // padding={styleSetting.layout === 'horizontal' ? {left: 10, right: 10} : {left: 0, right: 0} }
          ...
          <YAxis
            ...
            // interval={styleSetting.layout === 'vertical' ? 'preserveStartEnd' : null }
            ...
            // padding={styleSetting.layout === 'vertical' ? {left: 10, right: 10} : {left: 0, right: 0} }
            allowDataOverflow
            domain={
            ...
            // tickFormatter={styleSetting.layout === 'vertical' ? (value) => tickFormatter(value, '124') : null}
            tickFormatter={
              styleSetting.layout === "vertical"
                ? (value) => tickFormatter(value, data_index, xKey, "index")
                : (value) => tickFormatter(value)
          ...
          <Tooltip
            contentStyle={{
              backgroundColor: "rgba(85, 91, 102, 0.9)",
              borderColor: "#555b66",
              textAnchor: "start",
            }}
            wrapperStyle={{
