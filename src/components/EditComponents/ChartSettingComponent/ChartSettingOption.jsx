...
import TimeSeriesSetting from "./TimeSeriesSetting";
import StatChartSetting from "./StatChartSetting";

const ChartSettingOption = ({ panelID }) => {
  ...
  const switch_setting = () => {
    switch (chartData.value.chartType) {
      ...
      case "Compose Chart":
        return <ComposeSetting panelID={panelID} />;
      case "Time Series":
        return <TimeSeriesSetting />;
      case "Stat":
        return <StatChartSetting />;
      default:
        break;
    }
  };
