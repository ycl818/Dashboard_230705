...
const DropdownTitle = ({ title, panelID }) => {
  const { chartType, chartSetting, chartXkey, chartYkey } = useSelector(
    (state) => {
  ...
  const handleEditClick = () => {
    if (chartType !== null) {
      ...
      dispatch(setKeysColor(chartSetting.keysColor));
      switch (chartType) {
        case "Bar Chart":
          dispatch(setBarSetting(chartSetting.style));
          dispatch(
            setChartSetting({ type: "Recharts", setting: chartSetting.other })
          );
          break;
        ...
        case "Time Series":
          dispatch(setTimeSeriesSetting(chartSetting.style.setting));
          dispatch(setBarSetting(chartSetting.style.BarSetting));
          dispatch(setLineSetting(chartSetting.style.LineSetting));
          dispatch(setAreaSetting(chartSetting.style.AreaSetting));
          dispatch(
        ...
        case "Stat":
          dispatch(setStatSetting(chartSetting.style));
          break;
